...
// v13 typing differences: use flexible 'any' here to avoid mismatch with discord.js-selfbot-v13 union types
type ThumbnailComponent = any;
type MessageActionRowComponent = any;
type TopLevelComponent = any;
    ...
    case ComponentType.ActionRow:
      return (
        <DiscordActionRow key={id}>
          <>
            {component.components.map((nestedComponent: any, id: number) => (
